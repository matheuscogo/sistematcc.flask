...
namespace = Namespace('Matrizes', description='Matrizes')
...
@namespace.route('/<int:producer_id>/<int:id>', doc={"description": 'Pega matrizes'})
@namespace.param('producer_id', 'Identificador único do produtor')
@namespace.param('id', 'Identificador único do matrizes')
@namespace.expect(headers)
...
@namespace.route('/todos', doc={"description": 'Lista todos os matrizess'})
@namespace.expect(headers)
